...
begin
  ...
  Obj := OtsFirebase.API(edtApiKey.Text, edtProjectId.Text)
          ...
          .ToJSONObject();
  // TRUE parâmetro opcional para criar um usuário
...
begin
  ...
  Obj := OtsFirebase.API(edtApiKey.Text, edtProjectId.Text)
            ...
            .ToJSONObject();
  // SEM O TRUE esta chamada serve para autenticar um usuário na base
...
begin
  ...
  begin
    ...
    // Consumindo um projeto Firebase sem autenticação,
    // projeto com regras de segurança aberta
  ...
  begin
    ...
    // Autenticando e consumindo um Firebase
    // Requer regras de segurança especificas no firebase
